...
function deriveWinners(gameBoard, players){
  ...
  for (const combination of WINNING_COMBINATIONS){
    ...
    // check if any of the winning combinations have been found in the places winning combinations point
...
function App() {
  ...
  // console.log(...initalGameBoard.map(array => [...array]));
  for (const turn of gameTurns) {
      const { square , player } = turn;
      const {row, col } = square;

      gameBoard[row][col] = player; //put player symbol in gameBoard row and column
  }
